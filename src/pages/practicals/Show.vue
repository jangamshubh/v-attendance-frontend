                    ...
                    <table class="min-w-full border divide-y divide-gray-200">
                        <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                    {{ practical.start_date_time }}
                                </td>
                            </tr>
                            <tr>
                                <th>Assignment End Date Time</th>
                                <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                    {{ practical.end_date_time }}
                                </td>
                            </tr>
                            <tr>
                                <th>Late Submission Allowed ?</th>
                                <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap" v-if="practical.allow_late_submision == 1">
                                    Yes
                                </td>
                            ...
                            <tr>
                                <th>Subject</th>
                                <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                    {{ practical.practical_get_subjects.name }}
                                </td>
                            </tr>
                            <tr>
                                <th>Teacher</th>
                                <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                    {{ practical.practical_get_teachers.name }}
                                </td>
                            </tr>
                            <tr>
                                <th>Visibility ?</th>
                                <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap" v-if="practical.visibility == 1">
                                    Published
                                </td>
                                <td v-else>Draft</td>
                            </tr>
...
export default {
    data() {
        return {
            practical:{
                practical_get_subjects: {
                    name: '',
                },
                practical_get_teachers: {
                    name: '',
                },
            },
            batches:[],
    ...
    methods: {
        ...
        getPractical() {
            axios.get(`${process.env.VUE_APP_API_URL}/practicals/${this.$route.params.id}/show`,{ headers: authHeader() }).then(data => {
