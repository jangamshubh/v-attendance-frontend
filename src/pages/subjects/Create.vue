    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <Button label="Submit" v-on:click="saveSubject()" :disabled="v$.subject.$invalid"></Button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        saveSubject() {
            axios.post(`${process.env.VUE_APP_API_URL}/subjects/store`,this.subject, { headers: authHeader() }).then(data => {
